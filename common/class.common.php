...
class PermissionUtil{
    ...
    public static $REGISTRATIONSESSION_C='REGISTRATIONSESSION_C';
    public static $REGISTRATIONSESSION_R='REGISTRATIONSESSION_R';
    public static $REGISTRATIONSESSION_U='REGISTRATIONSESSION_U';
    public static $REGISTRATIONSESSION_D='REGISTRATIONSESSION_D';
...
class PageUtil{
    ...
    public static $REGISTRATIONSESSION='registrationsession.php';
...
class RouteUtil{
    ...
    private function RouteUtil(){
        ...
        //add new page and routing address here always
         ...
         self::$s_Routes[PageUtil::$REGISTRATIONSESSION]             =   "/modules/regs/view.registrationsession.php";
