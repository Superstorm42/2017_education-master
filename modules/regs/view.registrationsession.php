...
include_once 'blade/view.registrationsession.blade.php';
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Registration Session CRUD Operations</title>
	...
	<div id="form">
		<form method="post">
			<table width="100%" border="1" cellpadding="15">
				<tr>
					<td><input type="text" name="txtName" placeholder="Session" value="<?php 
...
<br />
	...
	?>
		<tr>
			<td>RegistrationSession Name</td>
		</tr>
		<?php
